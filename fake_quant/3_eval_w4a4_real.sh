# W4A4KV4 Real Quant evaluation
# Loads GPTQ quantized model, then applies real quant (int GEMM path)
# Expected GEMM: INT4_act × INT4_weight (main) + INT8_act × INT8_weight (high)
...
--rotate \
--real_quant \
--load_qmodel_path ./qmodels/W4A4KV4-Llama-3.2-1B.pt \
--tasks "boolq"
